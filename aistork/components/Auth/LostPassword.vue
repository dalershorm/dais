    ...
    <div class="mx-auto w-full max-w-sm">
      ...
      <div class="mt-8">
          ...
          <form @submit.prevent="NumberCheck" method="POST">
            <div>
              ...
              <div class="mt-1 rounded-md shadow-sm">
                <input id="tel" type="tel" v-model="phone" required class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5" minlength="9" maxlength="9" />
              </div>
            </div>
        ...
        <div class="mt-4" v-if="confirmed">
          <form @submit.prevent="lostPassword" method="POST">
            <div class="mb-4">
              <label for="tel" class="block text-sm font-medium leading-5 text-gray-700">
                Номер телефона
              </label>
              <div class="mt-1 rounded-md shadow-sm">
                <input id="tel" type="tel" v-model="phone" required disabled class="bg-gray-100 appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
              </div>
            </div>
            <div class="mb-4">
