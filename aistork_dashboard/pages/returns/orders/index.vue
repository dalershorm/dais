  ...
  <div class="px-6">
    <div class="w-full py-8">
      <div class="flex items-center justify-between w-full">
        <div class="">
          <h2 class="md:text-4xl text-2xl font-bold text-gray-700 mb-2.5">Возврат | Товары</h2>
          <span class="text-gray-800">Список возравщенных товаров.</span>
        </div>
        <div class="flex">
          <nuxt-link to="/returns/orders/create" class="d-btn d-btn-primary">
...
export default {
  ...
  methods: {
    init() {
      this.$axios.get('/dashboard/get-data?orders=5')
      .then(res=> {
